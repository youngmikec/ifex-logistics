                ...
                <div>
                        ...
                        <div className="relative w-full">
                            ...
                            <div className="flex justify-between absolute -top-6 w-full">
                                <span className={`p-4 rounded-full text-white lg:text-md md:text-md sm:text-sm 
                                    ${trackingDetail.status_name === 'PROCCESSING' ? 'bg-blue-400' : 'bg-gray-700'}`}
                                >
                                    <FiSettings />
                                </span>
                                <span className={`p-4 rounded-full text-white lg:text-md md:text-md sm:text-sm 
                                    ${trackingDetail.status_name === 'DEPARTED_HUB' ? 'bg-blue-400' : 'bg-gray-700'}`}
                                >
                                    <FiTruck />
                                </span>
                                <span className={`p-4 rounded-full text-white lg:text-md md:text-md sm:text-sm 
                                    ${trackingDetail.status_name === 'AT_DESTINATION' ? 'bg-blue-400' : 'bg-gray-700'}`}
                                >
                                    <FiPackage />
                                </span>
                                <span className={`p-4 rounded-full text-white lg:text-md md:text-md sm:text-sm 
                                    ${trackingDetail.status_name === 'ARRIVED' ? 'bg-blue-400' : 'bg-gray-700'}`}
                                >
                                    <FaHome />
                                </span>
                            </div>
                    ...
                    <div className='mt-16'>
                        <div className='flex justify-start my-6'>
                            <span className={`rounded-full p-3 ${trackingDetail.status_name === 'PROCCESSING' ? 'bg-blue-400' : 'bg-gray-700'}`}></span>
                            <div className='lg:mx-16 sm:mx-6 text-md'>Item is been Processed at orginating Hub</div>
                        </div>
                        <div className='flex justify-start my-6'>
                            <span className={`rounded-full p-3 ${trackingDetail.status_name === 'DEPARTED_HUB' ? 'bg-blue-400' : 'bg-gray-700'}`}></span>
                            <div className='lg:mx-16 sm:mx-6 text-md'>Item has Departed Hub</div>
                        </div>
                        <div className='flex justify-start my-6'>
                            <span className={`rounded-full p-3 ${trackingDetail.status_name === 'AT_DESTINATION' ? 'bg-blue-400' : 'bg-gray-700'}`}></span>
                            <div className='lg:mx-16 sm:mx-6 text-md'>Item has Arrived at the Destination Hub, pending collection</div>
                        </div>
                        <div className='flex justify-start my-6'>
                            <span className={`rounded-full p-3 ${trackingDetail.status_name === 'ARRIVED' ? 'bg-blue-400' : 'bg-gray-700'}`}></span>
